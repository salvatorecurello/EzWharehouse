...
describe("POST /api/skuitems/testResult", function(){
    it('should add new test result', function(done){
        ...
        .then(function(res){
            ...
            .send({name:"testmochatestdescriptorfortestresult", procedureDescription:"descriptionfortestresult", idSKU:skuid})
            .then(function(res){
...
describe("GET /api/skuitems/:rfid/testResults", function(){
    it('should get all test results for rfid', function(done){
        ...
        .then(function(res){
            ...
            skuid=res.body[0].id;
            agent.post("/api/testDescriptor")
            .send({name:"testmochatestdescriptorfortestresult2", procedureDescription:"descriptionfortestresult", idSKU:skuid})
            .then(function(res){
                res.should.have.status(201);
                agent.get("/api/testDescriptors")
                .then(function(res){
