...
class DAO {
    ...
    createTables() {
        ...
        sql.push('CREATE TABLE IF NOT EXISTS Item (ID INTEGER PRIMARY KEY AUTOINCREMENT, DESCRIPTION VARCHAR, PRICE FLOAT, SKUID INTEGER, SUPPLIERID INTEGER)');
        ...
        sql.push('CREATE TABLE IF NOT EXISTS TestResult (ID INTEGER PRIMARY KEY, SKUITEMID VARCHAR, IDTESTDESCRIPTOR INTEGER, DATE INTEGER, RESULT INTEGER)');
        ...
        return this.createTablesR(sql, 0).then(() => {
            return new Promise((resolve, reject) => {
                ...
                ords.push({ issueDate: 'issueDateEx1', state: states['COMPLETED'], customerID: 1 });
                ords.push({ issueDate: 'issueDateEx2', state: states['ACCEPTED'], customerID: 1 });
